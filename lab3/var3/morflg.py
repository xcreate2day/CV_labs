...
struct_element_B1 = cv2.getStructuringElement(cv2.MORPH_RECT, (7, 7))
struct_element_B2 = cv2.getStructuringElement(cv2.MORPH_RECT, (5, 5))

# Дилатация
dilated_image = cv2.dilate(binarized_and_inverted, struct_element_B1)
...
# Замыкание
closed_image = cv2.morphologyEx(binarized_and_inverted, cv2.MORPH_CLOSE, struct_element_B2)
...
cond_dilate_res1 = conditional_dilate_reconstruction(binarized_and_inverted, struct_element_B, struct_element_B1)
cond_dilate_res2 = conditional_dilate_reconstruction(binarized_and_inverted, struct_element_B1, struct_element_D)
...
morphological_skeleton = morphological_skeleton(binarized_and_inverted)
